...
function Problem(props) {
    ...
    return (
        ...
        <React.Fragment>
            <Router>
                <Link to="/container">to path of '/container'</Link>
                <br/>
    ...
    return (
        <div className="container">
            ...
            <Content>
                <ContentSide
                    sides={[
                        { id: 1, name: 'item_update', path: '/container/update' },
                        { id: 1, name: 'item_pay', path: '/container/pay' },
                    ]}
            />
                <ContentMain>
                    <Route path="/container/update" component={ConMainOfUpdate}/>
                    <Route path="/container/pay" component={ConMainOfPay}/>
                </ContentMain>
            </Content>
        </div>
    );
